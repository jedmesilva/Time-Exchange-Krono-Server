...
async def _liquidate_series(series: TimeSeries, db: AsyncSession):
    ...
    for position in positions:
        ...
        if next_series and next_price:
            ...
            # Debita titular, credita emissor
            ...
            # Atualiza posição para série seguinte
